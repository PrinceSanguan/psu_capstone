...
<div class="container mt-3">
    <h1>Edit Grading System for Subject ID: {{ $gradingSystem->subject_id }}</h1>
    ...
    <form action="{{ route('admin.updateGradingSystem', $gradingSystem->subject_id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" name="unit_test_percentage" id="unit_test_percentage"
                   class="form-control"
        ...
        <div class="form-group">
            ...
            <input type="number" name="activity_percentage" id="activity_percentage"
                   class="form-control"
